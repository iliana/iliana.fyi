...
fetch https://github.com/be5invis/Iosevka/releases/download/v15.1.0/webfont-iosevka-fixed-15.1.0.zip
unzip -jo Inter-3.19.zip "Inter Web"/Inter-{roman,italic}.var.woff2
unzip -jo webfont-iosevka-fixed-15.1.0.zip woff2/iosevka-fixed-extended{,bold}{,italic}.woff2
popd
